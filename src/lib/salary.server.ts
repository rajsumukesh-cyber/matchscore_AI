...
export async function predictSalaryBenchmark(
  ...
  return {
    ...
    base_salary_usd: {
      min: `$${baseMinInr},000`,
      median: `$${baseMedInr},000`,
      max: `$${baseMaxInr},000`,
    },
    expected_bonus_inr: `₹${Math.round(baseMedInr * 0.15)} to ₹${Math.round(baseMedInr * 0.25)} Lakhs (15% to 25%)`,
    expected_equity_inr: `₹${Math.round(baseMedInr * 0.3)} to ₹${Math.round(baseMedInr * 0.6)} Lakhs / year in RSUs`,
    market_percentile: 86,
    skill_boosts: [
      {
        skill: "Distributed System Design & Redis",
        annual_boost_inr: "+₹4.5 to 6.0 Lakhs/yr",
        annual_boost_usd: "+$18,000 to 25,000/yr",
        demand_level: "Ultra High",
      },
      {
        skill: "Generative AI / RAG & Vector Databases",
        annual_boost_inr: "+₹6.0 to 9.0 Lakhs/yr",
        annual_boost_usd: "+$25,000 to 35,000/yr",
        demand_level: "Ultra High",
      },
      {
        skill: "Kubernetes & Cloud Infrastructure (AWS/GCP)",
        annual_boost_inr: "+₹3.5 to 5.0 Lakhs/yr",
        annual_boost_usd: "+$15,000 to 20,000/yr",
        demand_level: "High",
      },
      {
        skill: "Automated E2E Testing (Playwright/CI/CD)",
        annual_boost_inr: "+₹2.5 to 3.5 Lakhs/yr",
        annual_boost_usd: "+$10,000 to 15,000/yr",
        demand_level: "High",
      },
    ],
    top_paying_companies: [
      {
        ...
        compensation_range_inr: "₹45L to ₹75L Base + RSUs",
        compensation_range_usd: "$190k to $275k Base + Equity",
      ...
      },
      {
        ...
        compensation_range_inr: "₹35L to ₹55L Total CTC",
        compensation_range_usd: "$140k to $190k Equivalent",
      ...
      },
      {
        ...
        compensation_range_inr: "₹38L to ₹60L Total CTC",
        compensation_range_usd: "$160k to $220k Base + Bonus",
        top_demanded_skills: ["Microservices", "Cloud Reliability", "CI/CD Automation"],
      },
    ],
    negotiation_strategy: {
      recommended_target: `Target the upper quartile: ₹${baseMedInr + 6} to ₹${baseMaxInr} Lakhs ($${baseMedUsd + 20}k to $${baseMaxUsd}k).`,
      key_leverage_points: [
